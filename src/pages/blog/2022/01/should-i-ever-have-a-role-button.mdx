...
description: This article takes a dive into the question of role="button" usability and provides insight into it's use. But you should never need to use it.
...
<Codepen id="abLjmdm" title="Button neves becomes inline" />
